...
import com.r2soft.freedoministriesinternational.packages.apis.SermonsApiRequestAdapter;

public class SermonView extends Fragment {
...
//        return super.onCreateView(inflater, container, savedInstanceState);
        ...
        View view = inflater.inflate(R.layout.sermons_layout, container, false);

        ajaxService.get(new SermonsApiRequestAdapter(view));
